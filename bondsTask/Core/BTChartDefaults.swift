...
//  bondsTask
//
//  Created by Dmitry Kudryavtsev on 02/01/2019.
//  Copyright © 2019 Dmitry Kudryavtsev. All rights reserved.
//

import Foundation
import SwiftCharts

struct BTChartDefaults {
    ...
    static var labelSettings: ChartLabelSettings {
        return ChartLabelSettings(font: BTChartDefaults.labelFont)
    }
    
    static var labelFont: UIFont {
        return BTChartDefaults.fontWithSize(Env.iPad ? 14 : 11)
    }
    
    static var labelFontSmall: UIFont {
        return BTChartDefaults.fontWithSize(Env.iPad ? 12 : 10)
    }
